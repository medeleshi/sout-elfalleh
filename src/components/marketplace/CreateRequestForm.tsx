...
export function CreateRequestForm({ categories, units, governorates }: CreateRequestFormProps) {
  ...
  const handleAction = async (formData: FormData) => {
    ...
    if (result.error) {
      ...
      router.push(`/marketplace/requests/${result.id}`);
    }
  };
  ...
  return (
    <form action={handleAction} ref={formRef}>
      <PublishingShell
        ...
        subtitle="اطلب ما تحتاجه من محاصيل ومنتجات"
        type="request"
